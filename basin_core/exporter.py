...
def generate_brief(workspace, accepted):
    ...
    lines = ['> ⚠️ **WHAT THIS ARTIFACT IS NOT:** This document is NOT a hydrologic drought-of-record analysis, NOT a safe-yield or delivery forecast, NOT a reservoir breach projection, and NOT validated against actual streamflow or surface evaporation.', '',
             ...
             '## Purpose and limits', '',
             'An analyst selected rainfall stress scenarios for deeper drought-planning analysis. Accept records a local rainfall-content review; it does not establish professional sign-off, validated catchment suitability, probability, reservoir inflow, freshwater availability or restriction dates.', '',
             'Stations are provisional NOAA GHCN-Daily regional proxies (primary coastal/urban stations: Corpus Christi network [Intl AP, NAS, NWS, Padre Island], Alice Intl, Kingsville network; regional context stations: Rockport, Victoria, San Antonio). Rainfall retention cannot be applied directly to naturalized streamflow. A domain specialist must determine geographic suitability, rainfall–runoff modeling, operating rules and any appropriate downstream modeling application.', '',
             *context_lines,
