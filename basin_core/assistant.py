...
DOMAIN_TOPICS: dict[str, str] = {
    ...
    "tutorial_confusing_alternative": (
        ...
        "- **What you can see**: Modeled day indices when the configured storage trajectory reaches illustrative comparison bands. These are assumption-driven sensitivity results, not projected dates, adopted drought stages, or operational forecasts.\n"
        ...
        "- **What it does**: Uses 4 adjustable priority weights (Severity, Duration, Concurrence, and Summer timing) plus K-Means clustering to group hundreds of rainfall sequences and select one high-scoring representative from each cluster for review.\n\n"
