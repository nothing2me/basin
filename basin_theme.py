...
.st-key-quick_other_tools button,.st-key-quick_next_step button,.st-key-quick_simple_terms button,.st-key-quick_custom_q button{width:100%!important;min-height:42px!important;justify-content:center!important;padding:7px 7px!important;border-radius:8px!important;border:1px solid color-mix(in srgb,var(--basin-border, #8796A0) 82%,transparent)!important;background:color-mix(in srgb,var(--basin-surface, #F3F6FA) 84%,transparent)!important;box-shadow:none!important;display:flex!important;align-items:center!important;gap:6px!important;transition:background .15s ease,border-color .15s ease,transform .12s ease!important;color:var(--basin-text-strong, #182127)!important}
.st-key-quick_other_tools button p,.st-key-quick_next_step button p,.st-key-quick_simple_terms button p,.st-key-quick_custom_q button p{font-size:.71rem!important;line-height:1.15!important;white-space:normal!important;text-align:center!important;margin:0!important;color:var(--basin-text-strong, #182127)!important;-webkit-text-fill-color:var(--basin-text-strong, #182127)!important;font-weight:650!important}
