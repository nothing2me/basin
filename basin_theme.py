...
.st-key-notes_drawer_open{background:color-mix(in srgb,var(--background-color,#1a2228) 98%,#000)!important;border:1.5px solid color-mix(in srgb,currentColor 28%,transparent)!important;border-bottom:none!important;border-radius:14px 14px 0 0!important;padding:10px 18px 16px 18px!important;box-shadow:0 -8px 32px rgba(0,0,0,.55)!important;height:var(--basin-notes-height, 420px)!important;min-height:180px!important;max-height:85vh!important;resize:vertical!important;overflow-y:auto!important;animation:basinSlideUp .35s cubic-bezier(0.16, 1, 0.3, 1) both!important;transition:height .25s cubic-bezier(0.16, 1, 0.3, 1), transform .35s cubic-bezier(0.16, 1, 0.3, 1)!important;will-change:transform,height}
@keyframes basinSlideUp{from{transform:translateY(100%);opacity:.3}to{transform:translateY(0);opacity:1}}
...
.st-key-assistant_drawer{position:fixed!important;top:0!important;right:0!important;width:var(--basin-assistant-width, 500px)!important;max-width:92vw!important;height:100vh!important;background:color-mix(in srgb,var(--background-color,#1e262c) 98%,#000)!important;border-left:2px solid color-mix(in srgb,currentColor 16%,transparent)!important;box-shadow:-8px 0 35px rgba(0,0,0,.45)!important;z-index:99998!important;padding:1.25rem 1.25rem 2rem!important;resize:horizontal!important;overflow-x:auto!important;overflow-y:auto!important;animation:basinDrawerSlideIn .35s cubic-bezier(0.16, 1, 0.3, 1) both!important;transition:width .25s cubic-bezier(0.16, 1, 0.3, 1), transform .35s cubic-bezier(0.16, 1, 0.3, 1)!important;will-change:transform,width}
@keyframes basinDrawerSlideIn{from{transform:translateX(100%);opacity:.4}to{transform:translateX(0);opacity:1}}
