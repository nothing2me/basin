...
| S07 | [City water-supply dashboard](https://www.corpuschristitx.gov/department-directory/corpus-christi-water/water-supply-dashboard/) | Operational context and policy-document discovery | Follow the drought-plan and official updates links. Record which statements are observed, assumed or projected. | Live text inspected; supplied policy PDF subsequently reviewed with page citations in review_findings.md |
...
- S07 links a plan labeled amended June 2026 and describes a Level 1 emergency in terms of projected supply-demand insufficiency. That needs reconciliation with the app's fixed Stage 4 percentage. The supplied policy snapshot has since been extracted; see review_findings.md for the policy table and remaining applicability questions. [S07](https://www.corpuschristitx.gov/department-directory/corpus-christi-water/water-supply-dashboard/)
