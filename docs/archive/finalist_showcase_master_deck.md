...
- **Speaker Script (Mohammed):**
  > *"The first AI component is unsupervised machine learning. Traditional tools either present hundreds of overwhelming scenarios or rely on cherry-picked worst cases. BASIN generates 300 candidate drought scenarios using synchronized multi-station historical resampling. It then projects these candidates into a 5-dimensional hydrologic feature space—measuring cumulative deficit, duration, spatial concurrence across stations, summer exposure, and dry-spell runs.*
  > 
