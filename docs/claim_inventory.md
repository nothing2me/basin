...
| Runtime AI is local KMeans plus deterministic weighted ranking; there is no product LLM. | Implemented and internally verified | `basin_core/analysis.py`, pinned scikit-learn, deterministic tests and offline smoke. Development used AI assistance and is disclosed separately. |
