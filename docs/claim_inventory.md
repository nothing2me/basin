...
| The bundled snapshot contains 1991–2025 NOAA GHCN-Daily point observations for 20 stations across all 11 Region N counties. | Automatically verified | `data/manifest.json` and snapshot checks. Brooks and Kenedy use their longest available records, ending in 2022 and 2017; gaps remain missing. Stations are screening evidence, not validated catchment rainfall. |
