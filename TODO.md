...
Owner / reviewer: Unclaimed; B17.6 implemented by Claude on `fix/b17-report-content-accuracy`, reviewer unassigned. Dynamic breach arithmetic and `include_notes=False` already exist; remaining integration is open.
